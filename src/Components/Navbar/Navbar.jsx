...
const Navbar = () => {
    ...
    return (
        // <div>
        //     <div className="navbar bg-[#1c2569] text-yellow-400">
        ...
        //     </div>
        // </div>
        <div className="navbar bg-[#03082F] text-yellow-400">
            ...
            <div className="flex-1">
                ...
                <Link to= "/" className="btn btn-ghost text-xl"><img src={logo} alt="logo" /></Link>
            </div>
            <div className="flex-none">
                <button className="btn btn-square btn-ghost">
